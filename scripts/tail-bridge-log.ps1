# Tails the Anya bridge log live in this PowerShell window.
# Usage:
#   pwsh -NoExit -File scripts\tail-bridge-log.ps1
# Or alias from your $PROFILE:
#   Set-Alias anya-tail "C:\Users\kumarashish\Projects\Anya\scripts\tail-bridge-log.ps1"

$logPath = Join-Path $env:LOCALAPPDATA 'Anya\bridge.log'

if (-not (Test-Path $logPath)) {
    Write-Host "No bridge.log yet at: $logPath" -ForegroundColor Yellow
    Write-Host "Open the Anya sidebar in Edge once, then re-run." -ForegroundColor Yellow
